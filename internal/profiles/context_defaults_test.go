...
func TestKnownContextWindowMatchesLeavesAndFastAliases(t *testing.T) {
	cases := []struct {
		...
		{"k3-256k", 262144},
		{"K3-256K", 262144},
		{"subscription/codex/gpt-5.6-sol", 320000},
		{"subscription/codex/gpt-5.6-sol-fast", 320000},
		{"subscription/codex/gpt-5.6-terra", 320000},
		{"subscription/codex/gpt-5.6-luna", 320000},
